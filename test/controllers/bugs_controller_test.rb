...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference("Bug.count") do
      post bugs_url, params: { bug: { actual_resolution_date: @bug.actual_resolution_date, approved: @bug.approved, assigned_tostatus: @bug.assigned_tostatus, comment_id: @bug.comment_id, created_by: @bug.created_by, identified_by: @bug.identified_by, image_url: @bug.image_url, indentified_date: @bug.indentified_date, issue_description: @bug.issue_description, issue_summary: @bug.issue_summary, modified_by: @bug.modified_by, priority: @bug.priority, progress: @bug.progress, related_project_id: @bug.related_project_id, resolution_summary: @bug.resolution_summary, target_resolution_date: @bug.target_resolution_date } }
    end
